...
boat_old_plot, = ax.plot([], [], 'ko', label="Trajectoire Bateau (Noir)", markersize=4, zorder=3)  # Points plus petits pour le bateau
target_old_plot, = ax.plot([], [], 'go', label="Trajectoire Cible (Gris)", markersize=4, linestyle=':', zorder=3)  # Pointillés pour la cible
