...
def capturer_donnees_acc(imu, duree=5):
    """
...
def calibration_accelerometre(beta=9.81, nb_mesures=4):
    """
    Effectue la calibration de l'accéléromètre à partir de nb_mesures dans différentes positions.
    ...
    for i in range(nb_mesures):
        ...
        donnees[i] = capturer_donnees_acc(imu)
